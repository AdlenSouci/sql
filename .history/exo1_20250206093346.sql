...
--insertions des données dans la table avec 30 notes
insert into notes values("maths",10);
insert into notes values("anglais",12);
insert into notes values("francais",14);
insert into notes values("physique",16);
insert into notes values("histoire",18);
insert into notes values("geographie",20);
insert into notes values("sport",22);
insert into notes values("sport",24);
insert into notes values("sport",26);
insert into notes values("sport",14);
