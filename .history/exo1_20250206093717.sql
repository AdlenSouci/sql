...
insert into notes values("physique",09);
insert into notes values("francais",09);
insert into notes values("histoire",07);
insert into notes values("geographie",11);
insert into notes values("sport",12);
insert into notes values("anglais",12);
insert into notes values("mathematiques",17);
insert into notes values("physique",12);
insert into notes values("francais",12);
insert into notes values("geographie",12);
insert into notes values("sport",19);
insert into notes values("histoire",12);
